...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('template/css/artemis-extension/_artemis-variables.scss') }}">
    <link rel="stylesheet" href="{{ asset('template/css/artemis-extension/_shuffle-extension.scss') }}">
    <link rel="stylesheet" href="{{ asset('template/css/maxmaxmax/_extension-max-width.scss') }}">
    <link rel="stylesheet" href="{{ asset('template/css/maxmaxmax/_variables.scss') }}">
...
<div class="">
    <section>
        <nav class="navbar d-lg-none navbar-light bg-white flex-wrap">
            <div class="container-fluid">
              <div class="d-flex w-100 align-items-center">
                <a class="navbar-brand show-mv-bw" href="#">
                  <img class="img-fluid" src="{{asset('image/ti-banner.png')}}" alt="" width="auto" style="height:50px !important;width:150px !important;">
                </a>
                <section class="">
                  <nav class="navbar navbar-expand-xl navbar-light bg-white flex-wrap"><div class="container-fluid">
                    <div class="d-flex w-100 align-items-center">
            ...
            <div class="position-fixed top-0 start-0 bottom-0 w-75 mw-sm-xs pt-6 bg-white overflow-auto">
              <div class="px-6 pb-6 position-relative border-bottom border-secondary-light">
                <div class="d-inline-flex align-items-center">
                  <a href="#">
                    <img class="img-fluid" src="{{asset('image/ti-banner.png')}}" alt="" width="auto">
                  </a>
                </div>
              </div>
              <div class="py-6 px-6">
                <div>
                  ...
                  <ul class="nav flex-column mb-8">
                    <li class="nav-item nav-pills">
                      <a class="nav-link text-secondary p-3 d-flex align-items-center" href="#">
                        <span class="d-inline-block me-3">
                          <i class="fa fa-dashboard" style="font-size:20px !important;"></i>
                        </span>
                    ...
                    <li class="nav-item nav-pills">
                      <a class="nav-link text-secondary p-3 d-flex align-items-center" href="#">
                        <span class="d-inline-block text-secondary me-3">
                          <i class="fa fa-area-chart" style="font-size:20px !important;"></i>
                        </span>
                        <span class="small text-secondary me-auto">Reports</span>
                  ...
                  @endcan
                    ...
                    <li class="nav-item nav-pills">
                      <a class="nav-link text-secondary p-3 d-flex align-items-center" href="#">
                        <span class="d-inline-block text-secondary me-4">
                          <i class="fa fa-sign-out" style="font-size:20px !important;"></i>
                        </span>
